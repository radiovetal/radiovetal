...
#define LCD_DATA_PIN_D7  PB0	/* arbitrary pin for LCD data line D7 */
#define LCD_DATA_PIN_D6  PB1	/* arbitrary pin for LCD data line D6 */
#define LCD_DATA_PIN_D5  PB2	/* arbitrary pin for LCD data line D5 */
